...
pub struct StorageConfig {
    ...
    pub janitor_failed_retention_secs: u64,
...
impl Default for StorageConfig {
    fn default() -> Self {
        StorageConfig {
            ...
            janitor_failed_retention_secs: 604800,
...
impl Config {
    ...
    fn apply_env(&mut self) {
        ...
        self.storage.janitor_failed_retention_secs = env_u64(
            "CRAW_JANITOR_FAILED_RETENTION_SECS",
            self.storage.janitor_failed_retention_secs,
        );
...
struct PartialStorage {
    ...
    #[serde(default)]
    janitor_failed_retention_secs: Option<u64>,
    #[serde(default)]
...
impl PartialStorage {
    fn merge_into(self, cfg: &mut StorageConfig) {
        ...
        if let Some(v) = self.janitor_failed_retention_secs {
            cfg.janitor_failed_retention_secs = v;
        }
