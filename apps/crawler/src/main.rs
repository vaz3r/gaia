...
fn log_effective_config(config: &Config) {
    tracing::info!(
        ...
        lead_source_grace_ms = config.fetch.lead_source_grace_ms,
        scheduler_claim_limit = config.retry.scheduler_claim_limit,
...
async fn report_loop(
    ...
    loop {
        ...
        tracing::info!(
            ...
            lead_dht_deferred = cur.lead_dht_deferred_total,
            lead_dht_started_grace_expired = cur.lead_dht_started_grace_expired_total,
            lead_dht_started_exhausted = cur.lead_dht_started_exhausted_total,
            lead_dht_avoided = cur.lead_dht_avoided_total,
            lead_grace_micros = cur.lead_grace_micros_total,
            lead_grace_completed = cur.lead_grace_completed_total,
