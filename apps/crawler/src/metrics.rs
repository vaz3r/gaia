...
pub struct Metrics {
    ...
    pub inbound_dropped_rate_limit: AtomicU64,
...
pub struct Snapshot {
    ...
    pub inbound_dropped_rate_limit: u64,
...
impl Metrics {
    pub fn snapshot(&self) -> Snapshot {
        Snapshot {
            ...
            inbound_dropped_rate_limit: self.inbound_dropped_rate_limit.load(Ordering::Relaxed),
