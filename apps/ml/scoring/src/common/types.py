...
class ReasonCode(str, Enum):
    ...
    RTLO_CHAR_SPOOFING = "RTLO_CHAR_SPOOFING"
    STANDALONE_SCRIPT_EXPLOIT = "STANDALONE_SCRIPT_EXPLOIT"
    
    # Suspicious Signals (deductions / DOWNRANK / REVIEW)
    IMPLAUSIBLE_SOFTWARE_PAYLOAD = "IMPLAUSIBLE_SOFTWARE_PAYLOAD"
    PASSWORD_TRAP_SUSPECTED = "PASSWORD_TRAP_SUSPECTED"
    LOCAL_PASSWORD_NOTE = "LOCAL_PASSWORD_NOTE"
